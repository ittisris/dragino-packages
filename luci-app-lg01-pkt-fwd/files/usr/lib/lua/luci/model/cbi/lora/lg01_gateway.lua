...
m = Map("lorawan", translate("LoRaWAN Gateway Settings"), translate("Configuration to communicate with LoRa devices and LoRaWAN server"))
...
local mcupin = s:option(Value, "reset_pin", translate("MCU Reset pin"))
mcupin.placeholder = "Pin to reset MCU"
mcupin.default = "1"
